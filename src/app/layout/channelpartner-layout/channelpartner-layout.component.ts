...
import { IstoreloginDetails } from 'src/app/shared/models/channelpartner/channelpartner.model';
@Component({
    selector: 'tru-channelpartner-layout',
    templateUrl: './channelpartner-layout.component.html',
    styleUrls: ['./channelpartner-layout.component.scss']
})
export class ChannelpartnerLayoutComponent implements OnInit {
    public collapedSideBar: boolean;
    public speech = new Speech();
    public talk: boolean = false;
    public storeloginDetails: IstoreloginDetails = <IstoreloginDetails>{};
    ...
    ngOnInit() {
        ...
        this.storeloginDetails = logindetails;
        this.storeloginDetails['flag'] = 0;
        ...
        (function (d, m) {
            ...
            var kommunicateSettings = {
                ...
                "voiceInput": true,
                "onInit": function () {
                    (window as any).Kommunicate && (window as any).Kommunicate.updateSettings(defaultSettings);
                    var events = {
