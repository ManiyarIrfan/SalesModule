...
@Component({
  selector: 'tru-xfactor-layout',
  templateUrl: './xfactor-layout.component.html',
  styleUrls: ['./xfactor-layout.component.scss'],
})
export class XfactorLayoutComponent implements OnInit {
  ...
  public slides = [
    ...
    { key: '../../../assets//images/KekaravLayout.jpg' },
